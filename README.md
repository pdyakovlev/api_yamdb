...
Команда разработки:
- :white_check_mark: [pdyakovlev (в роли Python-разработчика Тимлид - разработчик 1)](https://github.com/pdyakovlev/)
- :white_check_mark: [AndreyKhlestov (в роли Python-разработчика - разработчик 2)](https://github.com/AndreyKhlestov)
- :white_check_mark: [Nikita527 (в роли Python-разработчика - разработчик 3)](https://github.com/Nikita527)
